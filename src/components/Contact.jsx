...
const Contact = () => {
  ...
  return (
    <section className="section mb-12" id="contact">
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch lg:gap-4 ">
            <div className=" mb-12 lg:mb-0 lg:flex lg:flex-col">
                <h2 className="headline-2 lg:max-w-[15ch]">
                Contact me for collaboration
                </h2>

                <p className="mb-8 text-zinc-400 mt-4 max-w-[50ch] lg:max-w-[35ch]">Reach out today to discuss what your project needs and start collaborating on something amazing!
                </p>
                ...
                <div className="flex gap-4 items-center">
                    {
                        socialLinks.map(({href,icon,alt},key)=>(
                            ...
                            href={href}
                            key={key}
                            className='w-12 h-12 grid place-items-center ring-inset ring-1 ring-zinc-50/50 rounded-lg hover:bg-zinc-50 hover:text-zinc-950 transition-[background-color,color] active:bg-zinc-50/80'
                            target='_blank'
                            >
                                {icon}
                            </a>
            ...
            <form
            action="https://getform.io/f/ajjmxola"
            method='POST'
            ...
            >
                <div className="md:grid md:grid-cols-2 md:gap-2 md:items-center ">
                    ...
                    <div className="mb-4">
                        ...
                        <input type="email" name="email" id="email"  autoComplete='email' required placeholder='JohnDoe@example.com'
                        className='text-field'
                        />
                    </div>
                ...
                <div className="mb-4">
                        ...
                        <textarea name="message" id="message" className='text-field min-h-32 resize-y' placeholder='Hi'>

                        </textarea>
                    </div>

                    <button className='btn btn-primary [&]:max-w-full' type='submit'>Submit</button>
